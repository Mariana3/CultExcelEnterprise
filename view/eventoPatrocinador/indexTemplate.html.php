            ...
            <div class="sidebar-inner slimscrollleft">
                ...
                <div id="sidebar-menu">
                    <ul>
                        ...
                        <li><a href='<?php echo \mvc\routing\routingClass::getInstance()->getUrlWeb('eventoPatrocinador', 'index') ?>' class="active" ><i class='icon-home-3'></i><span>Evento Patrocinador</span> <span class="pull-right"></span></a></li>
        ...
        <div class="content-page">
            ...
            <div class="content">
                ...
                <div class="page-heading">
                    <h1><i class="fa fa-users"></i> Evento Patrocinador  <?php i18n::__('adminusu') ?></h1>
                    <h3>Evento Patrocinador Del Sistema</h3>            	</div>
                    ...
                    <div class="col-md-12">
                        <div class="widget">
                            <div class="widget-header">
                                <h2><strong> Evento Patrocinador<?php i18n::__('adminusu') ?></strong></h2>
                                ...
                                <div class="table-responsive">
                                    <form id="frmDeleteAll" class='form-horizontal' action="<?php echo routing::getInstance()->getUrlWeb('eventoPatrocinador', 'deleteSelect') ?>" method="POST">
                                        <div  style="margin-bottom: 10px; margin-top: 20px;">
                                            <a href="<?php echo routing::getInstance()->getUrlWeb('eventoPatrocinador', 'insert') ?>" class="btn btn-success btn-medium"><i class="fa fa-plus-square-o"></i> Nuevo</a>
                                            <a href="#" class="btn btn-danger btn-medium" onclick="borrarSeleccion()">Borrar</a>
                                            <a href="<?php echo routing::getInstance()->getUrlWeb('eventoPatrocinador', 'report') ?>" class="btn btn-default btn-medium"><i class="fa fa-file-pdf-o"></i> Exportar A PDF</a>
                                            ...
                                            <a class="btn btn-default btn-medium" href="<?php echo routing::getInstance()->getUrlWeb('eventoPatrocinador', 'deleteFilters') ?>"><i class="fa fa-minus-circle"></i> Eliminar Filtros</a>
                                        </div>
                                            ...
                                            <tbody>
                                                <?php foreach ($objEventoPatrocinador as $usuario): ?>
                                                  <tr>
                                                      ...
                                                      <td>
                                                          <a href="<?php echo routing::getInstance()->getUrlWeb('eventoPatrocinador', 'edit', array(eventoPatrocinadorTableClass::ID => $usuario->$id)) ?>" class="btn btn-primary btn-xs">Editar</a>
