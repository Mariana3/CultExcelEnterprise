            ...
            <div class="sidebar-inner slimscrollleft">
                ...
                <div id="sidebar-menu">
                    <ul>
                        ...
                        <li><a href='<?php echo \mvc\routing\routingClass::getInstance()->getUrlWeb('detallePqrs', 'index') ?>' class="active"><i class='icon-home-3'></i><span>Detalle Pqrs</span> <span class="pull-right"></span></a></li>
                                ...
                                <div class="table-responsive">
                                    <form id="frmDeleteAll" class='form-horizontal' action="<?php echo routing::getInstance()->getUrlWeb('detallePqrs', 'deleteSelect') ?>" method="POST">
                                        <div  style="margin-bottom: 10px; margin-top: 20px;">
                                            ...
                                            <a class="btn btn-default btn-medium" href="<?php echo routing::getInstance()->getUrlWeb('detallePqrs', 'deleteFilters') ?>"><i class="fa fa-minus-circle"></i> <?php echo i18n::__('Eliminar') ?> Filtros</a>
                                        </div>
