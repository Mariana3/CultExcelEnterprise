...
<div class="container container-fluid">
    <h1 class="page-header"><i class="fa fa-user"></i>  <?php echo i18n::__(((isset($objDatoUsuario)) ? 'update' : 'register')) ?> Datos Usuario<?php i18n::__('user') ?>  <?php echo $objDatoUsuario[0]->$datousuario ?> </h1>  
