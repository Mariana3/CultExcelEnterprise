    ...
    <div id="wrapper">
        ...
        <div class="left side-menu">
            <div class="sidebar-inner slimscrollleft">
                ...
                <div id="sidebar-menu">
                    <ul>
                        <li><a href='<?php echo \mvc\routing\routingClass::getInstance()->getUrlWeb('admin', 'index') ?>' ><i class='icon-home-3'></i><span><?php echo i18n::__('Admin') ?></span> <span class="pull-right"></span></a></li>
                        <li><a href='<?php echo \mvc\routing\routingClass::getInstance()->getUrlWeb('usuario', 'index') ?>' ><i class="fa fa-users fa-fw"></i><span><?php echo i18n::__('adminusuario') ?></span> <span class="pull-right"></span></a></li>
                        <li><a href='<?php echo \mvc\routing\routingClass::getInstance()->getUrlWeb('credencial', 'index') ?>' ><i class="fa fa-user"></i><span><?php echo i18n::__('Credenciales') ?></span> <span class="pull-right"></span></a></li>
                        <li><a href='<?php echo \mvc\routing\routingClass::getInstance()->getUrlWeb('bitacora', 'index') ?>' ><i class="fa fa-edit fa-fw"></i><span><?php echo i18n::__('Bitacora') ?></span> <span class="pull-right"></span></a></li>
                        <li><a href='<?php echo \mvc\routing\routingClass::getInstance()->getUrlWeb('evento', 'index') ?>' ><i class="fa fa-calendar"></i><span><?php echo i18n::__('Evento') ?></span> <span class="pull-right"></span></a></li>
                        <li><a href='<?php echo \mvc\routing\routingClass::getInstance()->getUrlWeb('categoria', 'index') ?>' ><i class='icon-home-3'></i><span><?php echo i18n::__('Categoria') ?></span> <span class="pull-right"></span></a></li>
                        <li><a href='<?php echo \mvc\routing\routingClass::getInstance()->getUrlWeb('datosusuario', 'index') ?>' class="active"><i class="fa fa-database"></i><span><?php echo i18n::__('Datos') ?></span> <span class="pull-right"></span></a></li>
                        ...
                        <li><a href='<?php echo \mvc\routing\routingClass::getInstance()->getUrlWeb('tipoDocumento', 'index') ?>' ><i class="fa fa-file-text-o"></i><span>Tipo Documento</span> <span class="pull-right"></span></a></li>
                        <li><a href='<?php echo \mvc\routing\routingClass::getInstance()->getUrlWeb('detallePqrs', 'index') ?>' ><i class='icon-home-3'></i><span>Detalle Pqrs</span> <span class="pull-right"></span></a></li>
                        <li><a href='<?php echo \mvc\routing\routingClass::getInstance()->getUrlWeb('estadoPqrs', 'index') ?>' ><i class='icon-home-3'></i><span>Estado Pqrs</span> <span class="pull-right"></span></a></li>
                        <li><a href='<?php echo \mvc\routing\routingClass::getInstance()->getUrlWeb('eventoPatrocinador', 'index') ?>'><i class='icon-home-3'></i><span>Evento Patrocinador</span> <span class="pull-right"></span></a></li>
                        <li><a href='<?php echo \mvc\routing\routingClass::getInstance()->getUrlWeb('patrocinador', 'index') ?>' ><i class='icon-home-3'></i><span>Patrocinador</span> <span class="pull-right"></span></a></li>
                        <li><a href='<?php echo \mvc\routing\routingClass::getInstance()->getUrlWeb('pqrs', 'index') ?>' ><i class='icon-home-3'></i><span>PQRS</span> <span class="pull-right"></span></a></li>
                        <li><a href='<?php echo \mvc\routing\routingClass::getInstance()->getUrlWeb('tarifa', 'index') ?>' ><i class='icon-home-3'></i><span>Tarifa</span> <span class="pull-right"></span></a></li>
                        <li><a href='<?php echo \mvc\routing\routingClass::getInstance()->getUrlWeb('tipoPqrs', 'index') ?>' ><i class='icon-home-3'></i><span>Tipo Pqrs</span> <span class="pull-right"></span></a></li>
                        <li><a href='<?php echo \mvc\routing\routingClass::getInstance()->getUrlWeb('usuarioGustaCategoria', 'index') ?>' ><i class='icon-home-3'></i><span>Usuario Gusta Categoria</span> <span class="pull-right"></span></a></li>
                </div>
                <div class="clearfix"></div>
                <div class="portlets">
                                    ...
                                    <form id="frmDeleteAll" class='form-horizontal' action="<?php echo routing::getInstance()->getUrlWeb('datosusuario', 'deleteSelect') ?>" method="POST">
                                        ...
                                        <table id="datatables-1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                            ...
                                            <tfoot>
                                                <tr>
                                                    <th><input type="checkbox" id="chkAll"></th>
                                                    <th><?php echo i18n::__('Nom') ?>Nombre</th>
                                                    <th><?php echo i18n::__('Apellido') ?>Apellido</th>
                                                    <th><?php echo i18n::__('Correo') ?>Correo</th>
                                                    <th><?php echo i18n::__('Genero') ?>Genero</th>
                                                    <th><?php echo i18n::__('Nacimiento') ?>Fecha De Nacimiento</th>
                                                    <th><?php echo i18n::__('Localidad') ?>Localidad</th>
                                                    <th><?php echo i18n::__('Tipo') ?>Tipo Doc</th>
                                                    <th><?php echo i18n::__('UsuarioID') ?>UsuarioID</th>
                                                    <th><?php echo i18n::__('actions') ?></th>
                                                </tr>
                                            </tfoot>
                                                ...
                                                <?php foreach ($objDatoUsuario as $usuario): ?>
                                                  <tr>
                                                      ...
                                                      <td>
                                                          ...
                                                          <a href="#" onclick="confirmarEliminar(<?php echo $usuario->$id ?>)" class="btn btn-danger btn-xs"><?php echo i18n::__('credusu') ?>Eliminar</a>
                                                      </td>
                                                  </tr>
                                                <?php endforeach ?>
                                            </tbody>
