...
<div id="container" class="boxed-page">
                ...
                <div class="row">
                    <div class="col-md-7">
                        ...
                        <div class="contact-details">
                            <a href="#"><i class="fa fa-map-marker"></i><?php echo i18n::__('lugar') ?> Santiago De Cali, Colombia</a>

                            <a href="#"><i class="fa fa-envelope-o"></i> info@yourcompany.com</a>

                            <a href="#"> <?php echo i18n::__('EXCEL') ?> <i class="fa fa-phone"></i> +57 345 678 000</a>
                        </div>
                        <!-- End Contact Info -->
                    </div><!-- .col-md-6 -->
                    <div class="col-md-5">
        ...
        <div class="navbar navbar-default navbar-top">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo \mvc\config\configClass::getUrlBase(), \mvc\config\configClass::getIndexFile() ?>"> <img src="<?php echo \mvc\routing\routingClass::getInstance()->getUrlImg('logo/logo.jpg') ?>" width="45" height="20" style="border-radius: 10px;" alt="Logo_index" ><strong> <?php echo i18n::__('EXCEL') ?>  |</strong></a>
                </div>
                <div class="navbar-collapse collapse">
                    ...
                    <div class="search-side">
                        ...
                        <div class="search-form">
                            <form autocomplete="off" role="search" method="get" class="searchform" action="#">
                                <input type="text" value="" name="s" id="s" placeholder="Buscar en Este Sitio ...">
                            </form>
                        </div>
                    </div>
                    <!-- End Search -->
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li>
                            <a href="<?php echo \mvc\config\configClass::getUrlBase(), \mvc\config\configClass::getIndexFile() ?>" class="active"><i class="fa fa-home"></i> <?php echo i18n::__('Inicio') ?></a>
                        </li>
                        <li>
                            ...
                            <ul class="dropdown">
                                ...
                                <li>
                                    <a href="404.html"><?php echo i18n::__('Tu') ?></a>
                                </li>
                                <li class="divider"></li>
                                <li>
                        ...
                        <li>
                            ...
                            <ul class="dropdown">
                                <li><a href="blog-item.html"><?php echo i18n::__('Vision') ?></a></li>
                                <li><a href="pricing.html"><?php echo i18n::__('Mision') ?></a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="portfolio-3.html"><?php echo i18n::__('Evento') ?></a>

                        </li>
                        <li>
                            <a class="btn btn-danger btn-medium" style="color: #2b2b2b; font-weight: bold;"  href="<?php echo \mvc\routing\routingClass::getInstance()->getUrlWeb('eventos', 'index') ?>"><?php echo i18n::__('Crear') ?></a>
                        </li>
                        <li><a href="<?php echo \mvc\routing\routingClass::getInstance()->getUrlWeb('contact', 'index') ?>"><?php echo i18n::__('Contacto') ?></a>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-user"></i> <?php echo \mvc\session\sessionClass::getInstance()->getUserName() ?><span class="caret"></span></a>
                            <ul class="dropdown" role="menu">
                                <li><a href="<?php echo \mvc\routing\routingClass::getInstance()->getUrlWeb('usuario', 'index') ?>"><i class="fa fa-user"></i> <?php echo i18n::__('Perfiles') ?></a></li>
                ...
                <div class="item">
                    ...
                    <div class="slider-content">
                        <div class="col-md-12 text-center">
                            ...
                            <h3 class="animated8 white">
                                <span style="color: #f7931e;"><?php echo i18n::__('Disfrutar') ?></span>
                            </h3>	
                            <div class="">
        ...
        <div class="container">
            ...
            <div class="section-video-content text-center">
                ...
                <h1 class="fittext wite-text uppercase tlt">
                    ...
                    <?php echo i18n::__('Manera') ?><br/><?php echo i18n::__('Forma') ?>Sencilla Y Rapida <strong><?php echo i18n::__('Para') ?></strong> <?php echo i18n::__('Nube') ?>
                </h1>
                <!-- End Animations Text -->


                <!-- Start Buttons -->
                <a href="#" class="btn-system btn-large border-btn btn-wite"><i class="fa fa-tasks"></i><?php echo i18n::__('Conocer') ?></a>
    ...
    <div class="section full-width-portfolio" style="border-top:0; border-bottom:0; background:#fff;">
        ...
        <div class="big-title text-center" data-animation="fadeInDown" data-animation-delay="01">
            <h1><?php echo i18n::__('Disfruta') ?><strong>   <?php echo i18n::__('Evento') ?> </strong><?php echo i18n::__('Ciudad') ?></h1>
        </div>
        <!-- End Big Heading -->
                    ...
                    <div class="row">
                        ...
                        <div class="section-video-content text-center">
                            ...
                            <h1 class="fittext wite-text uppercase tlt">
                                ...
                                <strong> <?php echo i18n::__('Propio') ?>tu propio evento</strong></br>
                                <?php echo i18n::__('Reúne') ?>Reúne a tu gente, o convierte tu pasión en negocio. </br>
                                <?php echo i18n::__('Reúne') ?>Cult Events te da todo lo que necesitas para crear el mejor evento que puedas imaginar.
                            </h1>
                            <!-- End Animations Text -->
                            ...
                            <a href="#" class="btn-system btn-large btn-wite"><i class="fa fa-plus-square-o"></i> Comenzar</a>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="big-title text-center">
                        <h1><?php echo i18n::__('Ahorra') ?>Ahorra Tiempo Y Dinero Con Nuestros Planes que Tenemos Para <strong><?php echo i18n::__('Ti') ?>Ti!</strong></h1>
                    </div>
                    <!-- End Big Heading -->
            ...
            <div class="row pricing-tables">
                ...
                <div class="col-md-3 col-sm-3 col-xs-12">
                    <div class="pricing-table">
                        <div class="plan-name">
                            <h3><?php echo i18n::__('Basico') ?>Basico</h3>
                        </div>
                ...
                <div class="col-md-3 col-sm-3 col-xs-12">
                    <div class="pricing-table">
                        <div class="plan-name">
                            <h3><?php echo i18n::__('Profesional') ?>Profesional</h3>
                        </div>
                        <div class="plan-price">
    ...
    <footer>
        <div class="container">
            ...
            <div class="copyright-section">
                <div class="row">
                    <div class="col-md-6">
                        <p>&copy; 2015 Portal Web -  Todos Los Derechos Reservados <a href="#">Diseño DICAL Web </a> </p>
                    </div><!-- .col-md-6 -->
                    <div class="col-md-6">
                        <ul class="footer-nav">
                            <li><a href="#">Sitemap</a>
