...
<?php $activated = estadoPqrsTableClass::ACTIVED ?>
            ...
            <div class="sidebar-inner slimscrollleft">
                ...
                <div id="sidebar-menu">
                    <ul>
                        ...
                        <li><a href='<?php echo \mvc\routing\routingClass::getInstance()->getUrlWeb('usuarioCredencial', 'index') ?>' ><i class="fa fa-unlock"></i><span>Usuario Credencial</span> <span class="pull-right"></span></a></li>
                        ...
                        <li><a href='<?php echo \mvc\routing\routingClass::getInstance()->getUrlWeb('estadoPqrs', 'index') ?>' class="active"><i class='icon-home-3'></i><span>Estado Pqrs</span> <span class="pull-right"></span></a></li>
        ...
        <div class="content-page">
            ...
            <div class="content">
                ...
                <div class="page-heading">
                    <h1><i class="fa fa-users"></i><?php echo i18n::__('Estado') ?>  <?php echo i18n::__('adminusu') ?></h1>
                    <h3><?php echo i18n::__('EstadoPQRSist') ?></h3>            	</div>
                    ...
                    <div class="col-md-12">
                        <div class="widget">
                            <div class="widget-header">
                                <h2><strong><?php echo i18n::__('Estado') ?> <?php echo i18n::__('adminusu') ?></strong></h2>
                            ...
                            <div class="modal fade" id="myModalfilter" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form method="POST" role="form" id="filterForm" action="<?php echo routing::getInstance()->getUrlWeb('estadoPqrs', 'index') ?>">
                                                <div class="form-group">
                            ...
                            <div class="widget-content">
                                ...
                                <div class="table-responsive">
                                    <form id="frmDeleteAll" class='form-horizontal' action="<?php echo routing::getInstance()->getUrlWeb('estadoPqrs', 'deleteSelect') ?>" method="POST">
                                        <div  style="margin-bottom: 10px; margin-top: 20px;">
                                            <a href="<?php echo routing::getInstance()->getUrlWeb('estadoPqrs', 'insert') ?>" class="btn btn-success btn-medium"><i class="fa fa-plus-square-o"></i> <?php echo i18n::__('Nuevo') ?> </a>
                                            <a href="#" class="btn btn-danger btn-medium" onclick="borrarSeleccion()"><?php echo i18n::__('Borrar') ?></a>
                                            <a href="<?php echo routing::getInstance()->getUrlWeb('estadoPqrs', 'report') ?>" class="btn btn-default btn-medium"><i class="fa fa-file-pdf-o"></i> <?php echo i18n::__('ExporPDF') ?> </a>
                                            ...
                                            <a class="btn btn-default btn-medium" href="<?php echo routing::getInstance()->getUrlWeb('estadoPqrs', 'deleteFilters') ?>"><i class="fa fa-minus-circle"></i> <?php echo i18n::__('EliminarFiltros') ?></a>
                                        </div>
                                        <table id="datatables-1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                            <thead>
                                                <tr>
                                                    <th><input type="checkbox" id="chkAll"></th>
                                                    <th><?php echo i18n::__('Nom') ?>  <?php i18n::__('usuario') ?></th>
                                                    <th><?php echo i18n::__('Activado') ?>  <?php i18n::__('fechaCreacion') ?></th>
                                                    <th><?php echo i18n::__('pqrs') ?>  <?php i18n::__('fechaCreacion') ?></th>
                                            ...
                                            <tbody>
                                                <?php foreach ($objEstadoPqrs as $usuario): ?>
                                                  <tr>
                                                      ...
                                                      <td>
                                                          ...
                                                          <a href="<?php echo routing::getInstance()->getUrlWeb('estadoPqrs', 'edit', array(estadoPqrsTableClass::ID => $usuario->$id)) ?>" class="btn btn-primary btn-xs"><?php echo i18n::__('Editar') ?></a>
