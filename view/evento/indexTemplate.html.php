            ...
            <div class="sidebar-inner slimscrollleft">
                ...
                <div id="sidebar-menu">
                    <ul>
                        ...
                        <li><a href='<?php echo \mvc\routing\routingClass::getInstance()->getUrlWeb('evento', 'index') ?>' class="active"><i class="fa fa-calendar"></i><span>Eventos</span> <span class="pull-right"></span></a></li>
        ...
        <div class="content-page">
            ...
            <div class="content">
                ...
                <div class="page-heading">
                    <h1><i class="fa fa-calendar"></i>  <?php echo i18n::__('evento') ?></h1>
                    ...
                    <div class="col-md-12">
                        <div class="widget">
                            <div class="widget-header">
                                <h2><strong><?php echo i18n::__('evento') ?></strong></h2>
                                        ...
                                        <table id="datatables-1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th><?php echo i18n::__('Latitud') ?></th>
                                            ...
                                            <tbody>
                                                <?php foreach ($objUsuarios as $usuario): ?>
                                                  <tr>
                                                      ...
                                                      <td><?php echo $usuario->$lugarlatitud ?></td>
                                                      <td>
